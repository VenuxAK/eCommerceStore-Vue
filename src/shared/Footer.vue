    ...
    <div class="mx-auto container xl:px-20 lg:px-12 sm:px-6 px-4 py-12">
      <div class="flex flex-col items-center justify-center">
        <div>
          <!-- class="" -->
          <h1
            class="text-gray-800 dark:text-white hover:text-gray-500 text-2xl"
          >
            <RouterLink to="/">
              e<span class="font-bold text-primary">Store</span>.
            </RouterLink>
          </h1>
        </div>
        <div
        ...
        <div class="flex items-center gap-x-8 mt-6">
          ...
          >
            <svg
              class="fill-current text-gray-800 dark:text-white hover:text-gray-500"
              width="22"
              height="22"
              viewBox="0 0 22 22"
              fill="none"
        ...
        <div class="flex items-center mt-6">
          <p class="text-base leading-4 text-gray-800 dark:text-gray-400">
            ...
            <span class="font-semibold">eStore</span>
          </p>
