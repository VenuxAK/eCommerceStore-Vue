          ...
          <div class="flex flex-col items-center">
            ...
            <div class="w-full flex-1 mt-8">
              ...
              <div class="mx-auto max-w-xs">
                ...
                <div class="mb-5">
                  <ErrorMessage v-if="errors.address" :error="errors.address" />
                  <textarea
                ...
                <button
                  @click="signup"
                  class="tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                >
                  <svg
                    class="w-6 h-6 -ml-2"
                    fill="none"
                ...
                <p class="mt-4 text-gray-700 font-medium">
                  ...
                  <RouterLink
                    to="signin"
                    class="font-bold text-primary hover:text-primary/90"
                  >
                    Sign in
                  </RouterLink>
                </p>
                <p class="mt-6 text-xs text-gray-600 text-center">
                  I agree to abide by eStore's
                  <RouterLink
                    to="/privacy-policy"
